...
def send_verification_email(user):
    ...
    try:
        ...
        logo_url = url_for('static', filename='images/qr.png', _external=True)
    ...
    if request.method == 'POST':
        try:
            ...
            if qr_type == 'link':
                ...
                content['phone'] = phone
                print(f"Call QR - Phone (cleaned): {phone}")
                ...
                print(f"SMS QR - Phone (cleaned): {phone}")
                ...
                print(f"WhatsApp QR - Phone (cleaned): {phone}")
